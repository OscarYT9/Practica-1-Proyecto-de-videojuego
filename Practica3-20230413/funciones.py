...
def opcion_cuatro():
    ...
    opciones = {
        ...
        '4. Listar libros por autor y año': lambda: imprimir_libros_por_anio_autor(libros, input("¿De qué autor deseas visualizar los libros?: "), int(input("¿De qué año deseas visualizar los libros?: "))),
